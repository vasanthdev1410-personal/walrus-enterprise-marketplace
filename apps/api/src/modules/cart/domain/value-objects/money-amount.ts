/**
 * WEMP-M07-SPEC-001 (decision D-05). A monetary amount stored in minor
 * currency units (cents). Non-negative; the authoritative price source is
 * Module 04's sellingPrice. Client-supplied authoritative prices are
 * prohibited (server-side only).
 */
