...
/** WEMP-M05-SPEC-001 §22 (D-14; M05-M5 writable config repository over inventory_config_records). */
export const INVENTORY_CONFIG_REPOSITORY = Symbol('INVENTORY_CONFIG_REPOSITORY');
/** WEMP-M05-SPEC-001 §15/§22 (M05-M5 admin inventory-config surface). */
export const INVENTORY_CONFIG_APPLICATION_SERVICE = Symbol('INVENTORY_CONFIG_APPLICATION_SERVICE');
