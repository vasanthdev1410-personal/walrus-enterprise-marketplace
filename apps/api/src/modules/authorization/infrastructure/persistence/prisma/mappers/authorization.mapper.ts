...
export const identityRoleAssignmentMapper = {
    ...
    return new IdentityRoleAssignment(
      compactProperties({
        ...
        assignedByIdentityId:
          record.assignedByIdentityId === null
            ? undefined
            : new UuidV7(record.assignedByIdentityId),
        assignmentOriginType: record.assignmentOriginType,
        assignedByWorkloadIdentity: record.assignedByWorkloadIdentity ?? undefined,
        authorityEvidenceReference: record.authorityEvidenceReference ?? undefined,
        operationId: record.operationId == null ? undefined : new UuidV7(record.operationId),
        auditCorrelationId:
          record.auditCorrelationId == null ? undefined : new UuidV7(record.auditCorrelationId),
        assignedAt: record.assignedAt,
        activatedAt: record.activatedAt,
        revokedByIdentityId:
          record.revokedByIdentityId === null ? undefined : new UuidV7(record.revokedByIdentityId),
        revokedAt: record.revokedAt ?? undefined,
        revocationReasonReference: record.revocationReasonReference ?? undefined,
  ...
  toPersistence(entity: IdentityRoleAssignment): Prisma.IdentityRoleAssignmentUncheckedCreateInput {
    ...
    return compactProperties({
      ...
      assignmentOriginType: value.assignmentOriginType,
      assignedByWorkloadIdentity: value.assignedByWorkloadIdentity,
      authorityEvidenceReference: value.authorityEvidenceReference,
      operationId: value.operationId?.value,
      auditCorrelationId: value.auditCorrelationId?.value,
      assignedAt: value.assignedAt,
      activatedAt: value.activatedAt ?? value.assignedAt,
      revokedByIdentityId: value.revokedByIdentityId?.value,
      revokedAt: value.revokedAt,
      revocationReasonReference: value.revocationReasonReference,
...
export const authorizationDecisionRecordMapper = {
  toDomain(record: AuthorizationDecisionRecordRow): AuthorizationDecisionRecord {
    return new AuthorizationDecisionRecord(
      compactProperties({
        ...
        resourceReference: record.resourceReference ?? undefined,
        targetIdentityId:
          record.targetIdentityId == null ? undefined : new UuidV7(record.targetIdentityId),
        reasonCode: record.reasonCode ?? undefined,
        workloadIdentity: record.workloadIdentity ?? undefined,
  ...
  toPersistence(
    ...
    return compactProperties({
      ...
      targetIdentityId: value.targetIdentityId?.value,
