...
import { CUSTOMER_PROFILE_REPOSITORY } from '../../customer.tokens';

/**
 * The customer scope resolved server-side for a self-service request. The
...
export interface CustomerScopedRequest extends Request {
  customerContext: CustomerRequestContext;
}

/**
 * WEMP-M06-SPEC-001 §12.2/§14 + WEMP-M06-AUTHZ-001 §4 (M06-M4, decision
 * D-07; Module 02 owner sign-off RECORDED 2026-08-17). The customer
 * self-service permission guard:
 *
 ...
 */
@Injectable()
export class CustomerSelfServicePermissionGuard implements CanActivate {
  public constructor(
  ...
  public async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    (request as CustomerScopedRequest).customerContext = { customerProfileId };
    return true;
  }
}
