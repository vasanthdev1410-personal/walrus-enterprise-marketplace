  ...
  it('contains the approved Module 01, Module 02 and Module 03 persistence records', () => {
    ...
    expect(models).toEqual(
      expect.arrayContaining([
        ...
        // Approved Module 02 (roles, permissions & authorization) records.
        ...
        // Approved Module 04 (product catalog, WEMP-M04-SPEC-001 §17).
        'Product',
        'ProductVariant',
        'ProductSku',
        'ProductCategory',
        ...
        // Approved Module 06 (customer management, WEMP-M06-SPEC-001 §13).
        'CustomerProfile',
        ...
        'CustomerPreference',
        'CustomerAuditRecord',
        // Approved Module 07 (shopping cart, WEMP-M07-SPEC-001 §13).
        'Cart',
        'CartLine',
        'CartStateTransition',
        'CartAuditRecord',
        // Approved Module 08 (order management, WEMP-M08-SPEC-001 §13).
        'Order',
        'OrderLine',
        'OrderStateTransition',
        'OrderAuditRecord',
        // Approved Module 09 (payment processing, WEMP-M09-SPEC-001 §13).
        'Payment',
        'PaymentAttempt',
        'PaymentRefund',
