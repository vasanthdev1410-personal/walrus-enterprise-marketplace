...
**Status:** M07-M1 AUTHORIZED (2026-08-18) — signed by the
Product/Architecture Owner. M07-M2…M07-M5 are **NOT** authorized and
...
**Implementation authority:** M07-M1 — granted by the §5 signature
(2026-08-18). M07-M2…M07-M5 are NOT authorized.
...
| M07-M2 Persistence                 | §5 approval + D-06/D-11 decisions + D-11 retention duration recorded                              |
| M07-M3 Application Services        | §5 approval + D-06/D-07/D-08/D-12/D-13/D-17 decisions                                             |
...
> conditions in §3 (Module 02 owner sign-off for cart.* permissions;
> Security/Platform D-10 rate-limit confirmation; Legal/Compliance
